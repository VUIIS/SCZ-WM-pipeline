...
function [Error]=DPARSFA_run_ADNI(AutoDataProcessParameter,WorkingDir,SubjectListFile,IsAllowGUI)
...
%Slice Timing (ADNI step 1 => FunImgA)
...
%Coregister T1 Image to Functional space (ADNI: step 3 =>)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%DARTEL and Normalize VBM results. %YAN Chao-Gan, 111111. (ADNI: step 5)
%Do Not Need Parfor
...
%Remove the nuisance Covaribles (NO)
if (AutoDataProcessParameter.IsCovremove==1) && (strcmpi(AutoDataProcessParameter.Covremove.Timing,'AfterRealign'))
...
%Normalize on functional data (ADNI: step 7 => FunImgARFW)
...
%Detrend (ADNI: step 8 => FunImgARFWD)
